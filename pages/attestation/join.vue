<template>
	...
	<apphead></apphead>
		<view class="container">
				<view class="tui-cancle" >请选择要加入的企业：{{selectVal}}</view>
			<view class="tui-searchbox">
				<view class="tui-search-input">
					<span class="iconfont icon-sousuo" :size='13' color='#333'></span>
					...
					<span class="iconfont icon-quxiao"  :size='13'  @tap="cleanKey" v-show="key"></span>
				</view>
			...
			<view v-show="key">
				...
				<view class="tui-result-box">
					<block v-for="(item,index) in searchList" :key="index">
						<view class="tui-result-item" hover-class="tui-opcity" :hover-stay-time="150" @tap="tapItem(item)">
		...
		<tui-button  type="blue" @tap="join">确定加入</tui-button>
	</view>
</template>
